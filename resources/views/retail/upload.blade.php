...
@section('title', 'Unggah Dokumen Keuangan')
@section('header', 'Pengarsipan Dokumen: ' . $perusahaan)
...
<div class="max-w-4xl mx-auto select-none animate-fade-in">
    ...
    <div class="bg-white rounded-3xl shadow-sm border border-gray-100 overflow-hidden">
        ...
        <div class="p-8 border-b border-gray-50 bg-gray-50/50">
            <h3 class="text-xl font-black text-[#0c1a3c] tracking-tight">Form Unggah Berkas PDF (Retail)</h3>
            <p class="text-xs text-gray-400 mt-1 uppercase tracking-widest font-bold flex items-center gap-1.5">
                <i class="fa-solid fa-shop text-sky-500"></i> Pastikan dokumen yang diunggah berkaitan dengan Finance/Keuangan Retail
            </p>
        </div>
        ...
        <form action="{{ route('dokumen.store') }}" method="POST" enctype="multipart/form-data" class="p-8 space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div class="space-y-1.5">
                    ...
                    <input type="text" name="nama_dokumen" value="{{ old('nama_dokumen') }}" placeholder="Contoh: Invoice Solar Mei 2026" required
            ...
            <div class="space-y-1.5">
                ...
                <textarea name="keterangan" rows="3" placeholder="Masukkan ringkasan revisi berkas atau catatan penting dokumen..."
